...
public class BoardingPass extends JFrame implements ActionListener {
    ...
    JTextField tfpnr;
    JLabel tfnationality, lblsrc, tfname, lbldest, lblfcode, labelfname, labeldate;
    JButton fetchButton;
    ...
    public BoardingPass() {
        ...
        JLabel lbladhar = new JLabel("PNR DETAILS");
        lbladhar.setBounds(60, 100, 150, 25);
        ...
        lblfcodeLabel.setBounds(60, 340, 150, 25);
        lblfcodeLabel.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(lblfcodeLabel);

        lblfcode = new JLabel();
        lblfcode.setBounds(220, 340, 150, 25);
        add(lblfcode);
